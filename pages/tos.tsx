...
const Tos: React.FC = () => {
  return (
    <Layout whiteBg>
      ...
      <Text>Last updated: November 26, 2022</Text>
      <Text>
      ...
      <UnorderedList>
        ...
        <ListItem>
          <Text>
            ...
            this Agreement) refers to Musikkjulekalender.no.
          </Text>
        </ListItem>
        <ListItem>
          <Text>
        ...
        <ListItem>
          <Text>
            <strong>Website</strong> refers to Musikkjulekalender.no, accessible
            from{" "}
            <a
              href="https://musikkjulekalender.no"
              rel="external nofollow noopener"
            >
              https://musikkjulekalender.no
            </a>
          </Text>
        </ListItem>
        <ListItem>
      ...
      <UnorderedList>
        <ListItem>By email: saiboten@gmail.com</ListItem>
      </UnorderedList>
    </Layout>
  );
};
